...
namespace JewelleryShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreatedDate,Stock,Description,Price,PhotoUrl")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, IFormFile PhotoUrl, [Bind("Id,Name,CreatedDate,Stock,Description,Price,PhotoUrl")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
