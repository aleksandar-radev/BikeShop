...
namespace FoodSupplementShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,BrandId,Price,PhotoUrl,CreatedDate")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, IFormFile PhotoUrl, [Bind("Id,Name,Description,BrandId,Price,PhotoUrl,CreatedDate")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
